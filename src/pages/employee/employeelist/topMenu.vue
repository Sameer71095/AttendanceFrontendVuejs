...
<div class="col-md-12 project-list">
    <div class="card">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group mb-0 me-0"></div><router-link class="btn btn-primary" to='/employee/add-employee'> <vue-feather class="me-1" type="plus-square"> </vue-feather>Add New Employee</router-link>
            </div>
        </div>
    </div>
</div>
...
<script>
import allPage from '../employeelist/allPage.vue'
import doingPage from '../employeelist/doingPage.vue'
import donePage from '../employeelist/donePage.vue'
export default{
    name:'topMenu',
    components:{
